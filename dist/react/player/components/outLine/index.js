...
function OutLine(props) {
  ...
  return (
    <div className={style.container}>
      <div style={{ width: unfold ? '308px' : '0px' }} className={style.content}>
        <div className={style.header}>{unfold ? '课程大纲' : ''}</div>
        {active && <Virtuoso
          ref={virtuoso}
      ...
      <div className={style.handle} onClick={() => changeUnfold(unfold)}>
