...
function DrawTool(props) {
  ...
  return (
    // <div className="box">
    <div id="draw" ref={drawRef} onWheel={handleWheel} className={`drawTools-draw ${cursorClassName}`} style={{ zIndex: (isNotHold && toolType === 'point') || isLoading ? -1 : 1 }} onClick={(e) => editText(e.nativeEvent)}>
