...
function CoverElements(props) {
  ...
  const { zmlCoverEleList, lessonInfo } = props;
  useEffect(()=>{
  ...
  const inLesson = lessonInfo.lesson_progress === lessonProgress.in;
  return (
...
CoverElements.propTypes = {
  ...
  lessonInfo: PropTypes.any
};
export default connect(
  ({ zmlCoverEleList, userInfo, lessonInfo })=>({ zmlCoverEleList, userInfo, lessonInfo }),
  ()=>({}))(CoverElements);
